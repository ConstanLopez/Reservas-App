...
def create_app():
    ...
    from .routes import auth, reservas, salas, turnos,admin_reservas,reportes,admin_participantes,admin_sanciones,admin_salas,admin_turnos,bi
    ...
    app.register_blueprint(admin_turnos.bp)
